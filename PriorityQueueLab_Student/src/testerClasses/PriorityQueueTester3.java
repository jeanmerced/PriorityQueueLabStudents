...
public class PriorityQueueTester3 {
	...
	public static void main(String[] args) {
		...
		//pq = new SortedListPriorityQueue<String, String>(new IntegerComparator1());    // 2
		//pq = new HeapListPriorityQueue<String, String>(new IntegerComparator1());      // 3
		//pq = new HeapPriorityQueue<String, String>(new IntegerComparator1());          // 4
